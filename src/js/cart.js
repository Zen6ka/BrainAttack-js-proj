...
const cartSelectedProducts = document.querySelector(
  '.js-cart-selected-products'
);
...
function localStorageCheck() {
  // ****** ізніше підшаманити, щоб просто повертати результат сховище, а логіку відпрацьовувати далі поза функцією.
