var at=Object.defineProperty;var ot=(t,e,s)=>e in t?at(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var D=(t,e,s)=>(ot(t,typeof e!="symbol"?e+"":e,s),s);import{s as m}from"./assets/icons-17156148.js";import{a as J}from"./assets/vendor-27c5a77b.js";document.addEventListener("DOMContentLoaded",function(){E();const t=JSON.parse(localStorage.getItem("popularProducts"));let e;t&&t.length>=5?e=t.slice(0,5):e=[],e.length>0?(Y(e),W()):ct()});async function ct(){const t=new R("products/popular","",1,5);try{const e=await t.fetchBreeds();nt(e);const s=e.slice(0,5);Y(s),W()}catch(e){console.error("Error:",e)}}function W(){E()}const rt=document.querySelector(".products-container");function nt(t){localStorage.setItem("popularProducts",JSON.stringify(t))}function Y(t){t.forEach(e=>{const s=document.createElement("div");s.classList.add("product-template"),s.innerHTML=`
