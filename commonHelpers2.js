var rt=Object.defineProperty;var lt=(t,e,s)=>e in t?rt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var G=(t,e,s)=>(lt(t,typeof e!="symbol"?e+"":e,s),s);import{s as y}from"./assets/icons-9c10ae57.js";import{a as j}from"./assets/vendor-27c5a77b.js";document.addEventListener("DOMContentLoaded",function(){k();const t=JSON.parse(localStorage.getItem("popularProducts"));let e;t&&t.length>=5?e=t.slice(0,5):e=[],e.length>0?(Z(e),X()):dt()});async function dt(){const t=new Y("products/popular","",1,5);try{const e=await t.fetchBreeds();gt(e);const s=e.slice(0,5);Z(s),X()}catch(e){console.error("Error:",e)}}function X(){k()}const ut=document.querySelector(".products-container");function gt(t){localStorage.setItem("popularProducts",JSON.stringify(t))}function Z(t){t.forEach(e=>{const s=document.createElement("div");s.classList.add("product-template"),s.innerHTML=`
