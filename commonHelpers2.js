var Q=Object.defineProperty;var W=(t,e,s)=>e in t?Q(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var B=(t,e,s)=>(W(t,typeof e!="symbol"?e+"":e,s),s);import"./assets/cart-99710f8e.js";import{a as y}from"./assets/vendor-27c5a77b.js";class P{constructor(e,s,o,r){B(this,"baseUrl","https://food-boutique.b.goit.study/api/");this.endPoint=e,this.filters=s,this.page=o,this.limit=r}async fetchBreeds(){try{return(await y.get(`${this.baseUrl}${this.endPoint}?${this.filters}&page=${this.page}&limit=${this.limit}`)).data}catch(e){console.error("Error:",e.message)}}}const G=document.querySelector(".search-form"),K=document.querySelector(".first-input-search"),F=document.querySelector(".filters-result"),z=document.querySelector(".first-select-search-not-focus"),M=document.querySelector(".button-categories"),V=document.querySelector(".span-button-categories"),D="products";let b="",p="",h=1,l=6,m={},C={},v={},d={},X=window.matchMedia("(min-width: 768px)").matches,Y=window.matchMedia("(min-width: 1280px)").matches;Y?l=9:X?l=8:l=6;function T(t,e,s,o){localStorage.setItem("data-for-search",JSON.stringify({keyword:t,category:e,page:s,limit:o}))}T(b,p,h,l);async function q(){try{const t=JSON.parse(localStorage.getItem("data-for-search")),e=`keyword=${t.keyword}&category=${t.category}`;d=await new P(D,e,h,l).fetchBreeds()}catch(t){S(),console.error("Error:",t.message)}}const S=()=>{const t=`<div class="error">
    <p class="title-error">
    ...
    <p class="p-error">
        Try adjusting your search parameters or browse our range by other criteria to find the perfect product for you.
                ...
                </li>`,e.push(r)}),F.innerHTML=`<ul class="card-list">${e.join(" ")}</ul>`,at(t)}function at(t){[...document.querySelectorAll(".cardlist-add-cart")].forEach(s=>{s.addEventListener("click",o=>{const r=o.currentTarget.getAttribute("id"),c=t.find(i=>i._id===r),a=localStorage.getItem("cart");if(a){const i=JSON.parse(a);i.push(c),localStorage.setItem("cart",JSON.stringify(i))}else localStorage.setItem("cart",JSON.stringify([c]));o.currentTarget.innerHTML=`<svg class="cardlist-svg" weight="18" height="18">
            <use href="../img/icons.svg#icon-check"></use>
            </svg>`,o.currentTarget.setAttribute("disabled","true")})})}const n={openModalBtn:document.querySelector('[data-action="open-modal"]'),closeModalBtn:document.querySelector('[data-action="close-modal"]'),backdrop:document.querySelector(".js-backdrop"),addToCart:document.querySelector(".modal-btn-sabmit"),discountProduct:document.querySelector(".modal-discount-svg"),onCart:document.querySelector(".modal-btn-sabmit-span"),modalImg:document.querySelector(".modal-img img"),modalTitle:document.querySelector(".modal-title"),modalCategory:document.querySelector(".modal-list li:nth-child(1) .modal-item-span"),modalSize:document.querySelector(".modal-list li:nth-child(2) .modal-item-span"),modalPopularity:document.querySelector(".modal-list li:nth-child(3) .modal-item-span"),modalDesc:document.querySelector(".modal-info-taxt"),modalPrice:document.querySelector(".modal-price")};n.openModalBtn.addEventListener("click",()=>O(n.openModalBtn.dataset.productId));n.closeModalBtn.addEventListener("click",_);n.backdrop.addEventListener("click",gt);const it=document.querySelectorAll(".cardlist-img");it.forEach(t=>{t.addEventListener("click",e=>nt(e))});function nt(t){const e=t.currentTarget.closest(".card-list-item").dataset.id;O(e)}const lt="https://food-boutique.b.goit.study/api/";async function O(t){window.addEventListener("keydown",R),document.body.classList.add("show-modal"),await ut(t),j(t),H()}async function dt(t){try{return(await y.get(`${lt}products/${t}`)).data}catch(e){return console.error("Error:",e.message),null}}async function ut(t){const e=await dt(t);if(e){n.modalImg.src=e.img,n.modalImg.alt=e.name,n.modalTitle.textContent=e.name,n.modalCategory.textContent=e.category,n.modalSize.textContent=e.size,n.modalPopularity.textContent=e.popularity,n.modalDesc.textContent=e.desc,n.modalPrice.textContent=`$${e.price.toFixed(2)}`;const s=j(t),o=$().includes(t);k(s,o)}}function k(t,e){const s=t?"Remove from":e?"Added to":"Add to";n.addToCart.querySelector(".modal-btn-sabmit-span").textContent=s,n.addToCart.disabled=t}function j(t){const s=$().includes(t);return n.addToCart.addEventListener("click",()=>{s?(pt(t),k(!1,!1)):(mt(t),k(!0,!0))}),s}function $(){return JSON.parse(localStorage.getItem("cart"))||[]}function mt(t){let e=$();e.includes(t)||(e.push(t),localStorage.setItem("cart",JSON.stringify(e)))}function pt(t){let e=$();const s=e.indexOf(t);s!==-1&&(e.splice(s,1),localStorage.setItem("cart",JSON.stringify(e)))}function _(){window.removeEventListener("keydown",R),document.body.classList.remove("show-modal"),H()}function gt(t){t.currentTarget===t.target&&_()}function R(t){t.code==="Escape"&&_()}function ft(){return document.body.classList.contains("show-modal")}function H(){document.body.style.overflow=ft()?"hidden":""}document.addEventListener("DOMContentLoaded",async function(){const t=new P("products/popular?limit=5");try{const e=ht();if(e)N(e);else{const s=await t.fetchBreeds();yt(s),N(s)}L()}catch(e){console.error("Error:",e)}});function yt(t){localStorage.setItem("popularProducts",JSON.stringify(t)),L()}function ht(){const t=localStorage.getItem("popularProducts");return t?JSON.parse(t):null}function N(t){const e=document.querySelectorAll(".product-template");e.forEach(s=>{s.querySelector(".product-image").src="",s.querySelector(".product-name").textContent="",s.querySelector(".category-value").textContent="",s.querySelector(".size-value").textContent="",s.querySelector(".popularity-value").textContent=""}),t.slice(0,e.length).forEach((s,o)=>{const r=e[o];r.style.display="flex",r.querySelector(".product-image").src=s.img,r.querySelector(".product-name").textContent=s.name,r.querySelector(".category-value").textContent=s.category.replace("_"," "),r.querySelector(".size-value").textContent=s.size,r.querySelector(".popularity-value").textContent=s.popularity;const c={_Id:s._id,name:s.name,img:s.img,category:s.category,price:s.price,size:s.size,is10PercentOff:s.is10PercentOff,popularity:s.popularity};r.querySelector(".product-image-container").addEventListener("click",function(){let g=[c];localStorage.setItem("popul",JSON.stringify(g)),O(c._Id)});const i=r.querySelector(".add-to-cart-btn");i.onclick=function(){St(c),U()},i.setAttribute("data-product-id",s._id)})}function St(t){let e=JSON.parse(localStorage.getItem("cart"))||[];const s=e.findIndex(o=>o._Id===t._Id);s!==-1?e.splice(s,1):e.push(t),localStorage.setItem("cart",JSON.stringify(e)),U(),L()}function L(){const t=JSON.parse(localStorage.getItem("cart"))||[];document.querySelectorAll(".cart-btn").forEach(s=>{const o=s.getAttribute("data-product-id"),r=s.querySelector(".icon-off"),c=s.querySelector(".icon-on"),a=t.some(i=>i._Id===o);r&&c&&(a?(s.classList.add("added-to-cart"),r.style.display="block",c.style.display="none"):(s.classList.remove("added-to-cart"),r.style.display="none",c.style.display="block"))})}function U(){document.dispatchEvent(new CustomEvent("cartUpdated"))}document.addEventListener("cartUpdated",()=>{L()});const u={formSubscription:document.querySelector(".footer-form"),openModalPolicy:document.querySelector(".js-modal-policy-open"),openModalTerms:document.querySelector(".js-modal-terms-open"),closeModalPolicyBtn:document.querySelector(".js-policy-close"),closeModalTermsBtn:document.querySelector(".js-terms-close"),policyLink:document.querySelector(".js-policy"),termsLink:document.querySelector(".js-terms")};u.formSubscription.addEventListener("submit",vt);const E=new P;E.endPoint="subscription";function vt(t){t.preventDefault();const e=t.currentTarget.elements.email.value;bt(e)}async function bt(t){y.defaults.baseURL=E.baseUrl;const e={method:"post",url:E.endPoint,headers:{"Content-Type":"application/json"},data:{email:t}};try{return(await y.request(e)).data}catch(s){console.log(s)}}u.openModalPolicy.addEventListener("click",()=>{J(),u.closeModalPolicyBtn.addEventListener("click",J)});u.openModalTerms.addEventListener("click",()=>{A(),u.closeModalTermsBtn.addEventListener("click",A)});function J(){u.policyLink.classList.toggle("is-hidden-policy")}function A(){u.termsLink.classList.toggle("is-hidden-policy")}const Ct=document.querySelector(".discount-container");let w=[],f=[];const qt=t=>{f.find(s=>s._id===t._id)||(f.push(t),localStorage.setItem("addedProducts",JSON.stringify(f)))},Pt=t=>f.some(e=>e._id===t);async function $t(){try{let e=function(c){const{_id:a,name:i,img:g,price:I}=c;return`<div class="discount-card">
              ...
              </div>`},s=function(c){return c.slice(0,2).map(e).join("")},o=function(){const c=s(w);Ct.innerHTML=c};w=(await y.get("https://food-boutique.b.goit.study/api/products/discount")).data,f=JSON.parse(localStorage.getItem("addedProducts"))||[],o();const r=document.querySelectorAll(".discount-card-button");Array.from(r).forEach(c=>{c.addEventListener("click",a=>{const i=a.currentTarget.dataset.id,g=w.find(I=>I._id===i);qt(g),o()})})}catch(t){console.error("Error fetching discount products:",t.message)}}$t();const Lt=document.querySelector("ul");let It=8;function wt(t,e){let s="",o,r=e-1,c=e;e>1&&(s+=`<li class="btn prev" onclick="element(totalPages, ${e-1})"><span><i class="left"></i> < </span></li>`);for(let a=r;a<=c;a++)a>t||(a==0&&(a=a+1),e==a?o="active":o="",s+=`<li class="numb ${o}"onclick="element(totalPages, ${a})"><span>${a}</span></li>`);e<t&&e<t&&(s+='<li class="dots"><span>...</span></li>',e<t+1&&(s+=`<li class="numb" onclick="element(totalPages, ${e})"><span>7</span></li>`,e<=t+2&&(s+=`<li class="numb" onclick="element(totalPages, ${e})"><span>8</span></li>`))),e<t&&(s+=`<li class="btn next"onclick="element(totalPages, ${e+1})"><span><i class="right"></i> > </span></li>`),Lt.innerHTML=s}wt(It,2);
