var nt=Object.defineProperty;var ct=(t,e,s)=>e in t?nt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var Q=(t,e,s)=>(ct(t,typeof e!="symbol"?e+"":e,s),s);import{s as f}from"./assets/icons-17156148.js";import{a as M}from"./assets/vendor-27c5a77b.js";document.addEventListener("DOMContentLoaded",function(){P();const t=JSON.parse(localStorage.getItem("popularProducts"));let e;t&&t.length>=5?e=t.slice(0,5):e=[],e.length>0?(V(e),G()):rt()});async function rt(){const t=new j("products/popular","",1,5);try{const e=await t.fetchBreeds();dt(e);const s=e.slice(0,5);V(s),G()}catch(e){console.error("Error:",e)}}function G(){P()}const lt=document.querySelector(".products-container");function dt(t){localStorage.setItem("popularProducts",JSON.stringify(t))}function V(t){t.forEach(e=>{const s=document.createElement("div");s.classList.add("product-template"),s.innerHTML=`
